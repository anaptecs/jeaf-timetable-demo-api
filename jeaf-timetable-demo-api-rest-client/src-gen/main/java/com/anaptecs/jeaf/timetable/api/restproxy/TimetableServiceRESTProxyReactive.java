 ...
 */
@Service
public class TimetableServiceRESTProxyReactive implements TimetableServiceReactive {
  /**
   ...
   */
  public TimetableServiceRESTProxyReactive( RESTRequestExecutorReactive pRequestExecutor,
   ...
   */
  @Override
  public Mono<TimetableResponse> executeTripSearch( TripSearchRequest request, DemoContext pContext ) {
    ...
    Mono<TimetableResponse> lResult = requestExecutor.executeSingleObjectResultRequest(lRequest, 200, lObjectType);
   ...
   */
  @Override
  public Mono<TimetableResponse> executeIntervalSearch( IntervalSearchRequest pRequest, DemoContext pContext ) {
    // Validate request parameter(s).
